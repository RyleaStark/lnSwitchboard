...
The supported toolchain is Python 3.11 or newer and Node.js 22.22.2 or newer. CI, release images, `.python-version`, and `.nvmrc` currently pin Python 3.14.6 and Node.js 22.23.1.
